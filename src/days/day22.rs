...
#[test]
fn test_day21_part1() {
    let input = match fs::read_to_string("./example/day22.txt".to_string()) {
        Ok(s) => s,
        Err(_) => panic!(),
    };
    assert_eq!(exec_day22_part1(&input), "37327623")
}

#[test]
fn test_day21_part2() {
    let input = match fs::read_to_string("./example/day22_2.txt".to_string()) {
        Ok(s) => s,
        Err(_) => panic!(),
    };
    assert_eq!(exec_day22_part2(&input), "23")
}
